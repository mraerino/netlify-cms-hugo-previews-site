module github.com/mraerino/netlify-cms-hugo-previews-site

go 1.14

replace github.com/fsnotify/fsnotify => /Users/marcus/src/mraerino/fsnotify

replace github.com/gohugoio/hugo => /Users/marcus/src/gohugoio/hugo
